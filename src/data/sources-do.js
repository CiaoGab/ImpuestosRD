...
export const SOURCES_DO = [
  {
    ...
    note: "Incluye la aclaración de que para envíos vía courier por debajo de US$200, el cobro de Aduanas es la tasa de servicio (Decreto 627-06)."
  },
  {
    ...
    note: "Base legal de la tasa de servicio (incluye referencia a US$0.25 por kilo o fracción, con tope por documento)."
  },
  {
    title: "DGII – ITBIS (definición y aplicación a importaciones)",
    url: "https://dgii.gov.do/cicloContribuyente/obligacionesTributarias/principalesImpuestos/Paginas/Itbis.aspx",
    note: "Describe el ITBIS como un impuesto que aplica a la transferencia e importación de bienes industrializados y servicios."
  },
  {
  ...
  },
  {
    ...
    note: "Norma que regula el fraccionamiento de mercancías a través de empresas courier (origen del RUA)."
  }
];
